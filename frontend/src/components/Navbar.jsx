...
//console.log(user)
  ...
  Object.keys(user).length === 0 ? (
    <>
    <div className="md:hidden flex space-x-6 mr-4">
      <Link to="/signin" className="text-white rounded-xl py-2 px-4 bg-[#39b97d] shadow-[inset_5px_5px_5px_-1px_#20754e,inset_-5px_-5px_5px_-1px_#53e6a1]">Log In</Link>
      <Link to="/signup" className="text-white rounded-xl py-2 px-4 bg-[#39b97d] shadow-[inset_5px_5px_5px_-1px_#20754e,inset_-5px_-5px_5px_-1px_#53e6a1]">Sign Up</Link>
    </div>
